...
print "label,request_type,samples,response_time,,std,ci95,serialization_time,std,ci95,deserialization_time,std,ci95,network_time,std,ci95"
for request_type in range(8):
    ...
    network_time_array          = np.array(network_time           [request_type])
