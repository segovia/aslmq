...
# print "step 3"
average_database_time =             [0.0 if c == 0 else x/(c*msInNs) for x, c in izip(response_time_sum, msg_count)];
...
average_network_time_sum = average_network_time_sum[binsToDiscard:bins-binsToDiscard-1]
